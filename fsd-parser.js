...
var grammar = {
    ...
    {"name": "method", "symbols": ["descriptors", {"literal":"method"}, "_", (lexer.has("name") ? {type: "name"} : name), "_", "dataBody", "_", {"literal":":"}, "_", "dataBody"], "postprocess": d => ({ ...d[0], type: d[1], name: d[3], requestBody: d[5], responseBody: d[9] })},
    {"name": "dto", "symbols": ["descriptors", {"literal":"data"}, "_", (lexer.has("name") ? {type: "name"} : name), "_", "dataBody"], "postprocess": d => ({ ...d[0], type: d[1], name: d[3], members: d[5] })},
    ...
    {"name": "dataMember", "symbols": ["descriptors", (lexer.has("name") ? {type: "name"} : name), "_", {"literal":":"}, "_", "dataType", "dataMember$ebnf$1", "_", {"literal":";"}], "postprocess": d => ({ ...d[0], name: d[1], type: d[5], isRequired: d[6]?.value === '!' })},
    ...
    {"name": "errors", "symbols": ["descriptors", {"literal":"errors"}, "_", (lexer.has("name") ? {type: "name"} : name), "_", "enumBody"], "postprocess": d => ({ ...d[0], type: d[1], name: d[3], errors: d[5] })},
    {"name": "enum", "symbols": ["descriptors", {"literal":"enum"}, "_", (lexer.has("name") ? {type: "name"} : name), "_", "enumBody"], "postprocess": d => ({ ...d[0], type: d[1], name: d[3], types: d[5] })},
    ...
    {"name": "enumType", "symbols": ["descriptors", (lexer.has("name") ? {type: "name"} : name)], "postprocess": d => ({ ...d[0], name: d[1] })},
    ...
    {"name": "attribute", "symbols": [(lexer.has("name") ? {type: "name"} : name), "attribute$ebnf$1"], "postprocess": d => ({ name: d[0], params: d[1] && d[1][1]})},
    ...
    {"name": "pair", "symbols": [(lexer.has("name") ? {type: "name"} : name), "_", {"literal":":"}, "_", "parameterValue"], "postprocess": d => ({ key: d[0], value: d[4] })},
